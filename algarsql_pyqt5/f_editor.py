import ui.d_editor as d_editor
import dm
import dm_const
...
class form(QDialog):
    def __init__(self):
        ...
        self.lista_chk_obj = [self.ui.chk_obj_table,self.ui.chk_obj_view,self.ui.chk_obj_trigger,self.ui.chk_obj_package,self.ui.chk_obj_procedure,self.ui.chk_obj_funcion, self.ui.chk_obj_sequence]
