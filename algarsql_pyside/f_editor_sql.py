...
from PySide6.QtGui import QPainter, QTextFormat, QTextCharFormat, QColor, QFont, QSyntaxHighlighter, QTextCursor, QTextOption
...
C_functions = [
    ...
    "lpad","rpad","trunc","truncate", "to_date","to_char","to_number","nvl","decode","sysdate","count",
...
class EDITOR_SQL(QPlainTextEdit):
    ...
    # (restante do código idêntico à sua versão original, apenas com PySide6)
    ...
    def finder_prepare(self, params=None):
        if params:
            ...
            dm.f_principal.ui.edt_find_text.setText( self.getSelectedText() )
