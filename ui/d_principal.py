...
class Ui_d_principal(object):
    def setupUi(self, d_principal):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 561, 319))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 561, 517))
        ...
        self.edt_find_text = QtWidgets.QLineEdit(self.page_3)
        self.edt_find_text.setGeometry(QtCore.QRect(100, 20, 171, 26))
        ...
        self.edt_find_replace = QtWidgets.QLineEdit(self.page_3)
        self.edt_find_replace.setGeometry(QtCore.QRect(100, 60, 171, 26))
        self.edt_find_replace.setObjectName("edt_find_replace")
        self.groupBox = QtWidgets.QGroupBox(self.page_3)
        self.groupBox.setGeometry(QtCore.QRect(10, 90, 261, 91))
